...
class MessagesViewController: MSMessagesAppViewController {
    ...
    func createNewMessage() {
        ...
        boardView.drawHierarchy(in: CGRect(x: 0, y: 25, width: 150, height: 150), afterScreenUpdates: false)
        ...
        if game.gameInfo.newGame == true {
            layout.caption = "Tap to join me in a game of ExOh! (I'm Ex and you're Oh!)"
        }
        else if game.gameInfo.gameWon.isWin == true {
            
            switch game.gameInfo.gameWon.winType {
            case "draw"?:
            ...
            layout.caption = "$\(activeConversation!.localParticipantIdentifier.uuidString) played. Your turn!"
        }
        ...
        message.url = parser.encodeURL(gameInfo: game.gameInfo)
